...
def n_hop_query(G, entity, hops=2):
    """Return all nodes within N hops of an entity."""
    entity = str(entity)
...
def fund_flow_query(G, entity, hops=2, direction="both"):
    """
    Trace relationships around an entity.

    Note: this follows graph connectivity/direction.
    It does not calculate BTC amounts by itself.
    """
    entity = str(entity)
    ...
    if len(selected) == 0:
        ...
        if investigation_graph is not None:
            ...
            st.warning(
                ...
                "Run entity_graph_modified.py first."
            )
